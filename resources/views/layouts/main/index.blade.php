                ...
                <div class="app-brand demo">
                    <a href="/" class="app-brand-link">
                        <span class="app-brand-logo demo">
                            <img src="@if (Storage::disk('public')->exists('logo-aplikasi')) {{ asset('storage/' . $app[0]->logo) }} @else {{ asset('assets/img/logo-aplikasi/logo.svg') }} @endif"
                                class="h-auto" style="width: 28px;" alt="Logo-{{ $app[0]->name_app }}">
                        </span>
                        <span class="app-brand-text demo menu-text text-primary fw-bolder ms-2"
                            style="font-family: 'Lobster', cursive; letter-spacing:1px;">{{ $app[0]->name_app }}</span>
                    </a>
                        ...
                        <div
                            ...
                            <div class="mb-2 mb-md-0">Copyright&nbsp;
                                <script>
                                    ...
                                    class="footer-link">{{ $app[0]->name_app }}.</a>&nbsp;All rights reserved.
                            </div>
                        </div>
                    </footer>
